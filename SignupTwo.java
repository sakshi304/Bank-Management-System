...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(int formno){
        ...
        ButtonGroup seniornetgroup= new ButtonGroup();
        seniornetgroup.add(r1);
        seniornetgroup.add(r2);
        ...
        ButtonGroup acntexistinggroup= new ButtonGroup();
       acntexistinggroup.add(r3);
       acntexistinggroup.add(r4);
